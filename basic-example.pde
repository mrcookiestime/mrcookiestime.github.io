...
if (turn % 2 === 0 && mousePressed && mouseX < x1 && mouseX > x2 && mouseY < y1 && mouseY > y2 && taken[squareNum] === 0) {drawX(x2 + 25, y2 + 25);
turn++;
taken[squareNum] = "x";
}
else if (mousePressed && turn % 2 > 0 && mouseX < x1 && mouseX > x2 && mouseY < y1 && mouseY > y2 && taken[squareNum] === 0) {drawO(x2 + 60, y2 + 60);
turn++;
taken[squareNum] = "o";
}
